...
The entire code base, built in Python, aas well as suggested approach for build tools and web deployment was accomplished with Google Gemini Pro utilizing their Coding partner GEM and human generated prompts. GitHub Codespace was used as the IDE for development, testing, and debugging. The application is built with Streamlit and deployed on Streamlit Cloud.
